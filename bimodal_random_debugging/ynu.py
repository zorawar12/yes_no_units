...
def data_visualize(file_name,save_plot,x_var_,y_var_,cbar_orien,line_labels,data =None,num_of_opts=None):
    ...
    x_2 = []
    for i in x:
        [_1,intermediate_x,intermediate_fx] = finding_gaussian_base(1-(1/number_of_options),i,sigma_x_1)
        [_2,intermediate_x,intermediate_fx] = finding_gaussian_base(1-(1/(number_of_options+1)),i,sigma_x_1)
        x_1.append(_1)
        x_2.append(_2)
...
for nop in number_of_opts:
    ...
    save_string = "3delta_mu_5_mu_h_vs_mu_x1_mu_x2_vs_RCDnop5" #save_data('delta_mu_'+str(delta_mu)+'_mu_h_vs_mu_x1_mu_x2_vs_RCD'+'nop'+str(nop))
    ...
    data_visualize(file_name=save_string+".csv",save_plot=save_string,x_var_='$\mu_{x_1}$',y_var_='$\mu_{h_1}$',cbar_orien="vertical",num_of_opts=nop,line_labels=[number_of_options,number_of_options+1])
